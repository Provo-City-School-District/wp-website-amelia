...
function theme_specific_stylesheet()
{
    ...
    wp_enqueue_style('parent-style', get_template_directory_uri() . '/style.css', '', '1.0.18', false);
    wp_enqueue_script('slick-script', get_template_directory_uri() . '/assets/slick/slick.min.js', array('jquery'), null, true);
    wp_enqueue_script('my-custom-scripts', get_template_directory_uri() . '/assets/js/scripts.js', array('jquery', 'slick-script',), '1.0.02', true);
    if (is_404()) {
...
function to_title_case($string)
{
    ...
    $acronyms_and_such = array(
        'pcsd', 'cte', 'id', 'i.d.', 'vi', 'stem', 'ap', 's.t.e.m.', 's.t.e.a.m.', 'pta', 'p.t.a.', 's.t.a.r.', 'usda', 'pe', 'p.e.', 'byu', 'b.y.u.', 'uvu', 'u.v.u.', 'psd', 'act', 'ths', 'phs', 'ihs', 'cms', 'dms', 't.h.s.', 'p.h.s.', 'i.h.s.', 'c.m.s.', 'd.m.s.', 'scc', '(scc)', 'ksl', 'naep', 'fbla', 'deca', 'sep', 'd.c.', 'nyc', 'cdc', 'covid', 'covid19', 'covid-19'
    );
    $article_title_exceptions = array(
        'One-A' => 'one-a', 'One-B' => 'one-b', 'DeAnna' => 'deanna', 'SafeUT' => 'safeut', 'COVID-19' => 'covid-19', 'SplashLearn' => 'splashlearn'
    );
